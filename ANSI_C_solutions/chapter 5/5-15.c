...
int main(int argc, char *argv[])
{
    ...
    {
        printf("\n\n-----------------\nI am Dividing lines\n-----------------\n");
        qsort((void **) lineptr, 0, nlines-1, (int (*)(void*, void*))(numeric ? numcmp : (is_flodcase ? strcmp_f : strcmp)), is_reverse);
...
int strcmp_f(char *v1, char *v2)
{
    for (; toupper(*v1) == toupper(*v2); v1++, v2++)
        if (*v1 == '\0')
            return 0;
